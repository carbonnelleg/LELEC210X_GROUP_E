...
class eval_limesdr(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "LELEC2102 - Decode SDR", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("LELEC2102 - Decode SDR")
        ...
        self.settings = Qt.QSettings("GNU Radio", "eval_limesdr")
        ...
        self.detect_threshold_entry = detect_threshold_entry = (1e-3)
        ...
        self._detect_threshold_entry_tool_bar = Qt.QToolBar(self)
        self._detect_threshold_entry_tool_bar.addWidget(Qt.QLabel("Detection Threshold" + ": "))
        self._detect_threshold_entry_line_edit = Qt.QLineEdit(str(self.detect_threshold_entry))
        self._detect_threshold_entry_tool_bar.addWidget(self._detect_threshold_entry_line_edit)
        self._detect_threshold_entry_line_edit.returnPressed.connect(
            lambda: self.set_detect_threshold_entry(eng_notation.str_to_num(str(self._detect_threshold_entry_line_edit.text()))))
        self.top_layout.addWidget(self._detect_threshold_entry_tool_bar)
        ...
        self.fsk_preamble_detect_0 = fsk.preamble_detect(data_rate, fdev, samp_rate, packet_len, detect_threshold_entry, Enable_detection)
        ...
        self.connect((self.low_pass_filter_0, 0), (self.fsk_onQuery_noise_estimation_0, 0))
    ...
    def set_data_rate(self, data_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 62.5e3, (self.data_rate*1), window.WIN_HAMMING, 6.76))
    ...
    def get_detect_threshold_entry(self):
        return self.detect_threshold_entry

    def set_detect_threshold_entry(self, detect_threshold_entry):
        self.detect_threshold_entry = detect_threshold_entry
        Qt.QMetaObject.invokeMethod(self._detect_threshold_entry_line_edit, "setText", Qt.Q_ARG("QString", eng_notation.num_to_str(self.detect_threshold_entry)))
        self.fsk_preamble_detect_0.set_threshold(self.detect_threshold_entry)
    ...
    def set_Enable_detection(self, Enable_detection):
        ...
        self._Enable_detection_callback(self.Enable_detection)
        self.fsk_preamble_detect_0.set_enable(self.Enable_detection)




def main(top_block_cls=eval_limesdr, options=None):
