...
def main():
    ...
    csv_files = {
        0: {'filename': 'data_49_007.csv', 'trim_start' : 0, 'trim_end': -1},
        1: {'filename': 'data_49_008.csv', 'trim_start' : 0, 'trim_end': -1},
        2: {'filename': 'data_49_009.csv', 'trim_start' : 0, 'trim_end': -1},
    }

    R = 100.54
    OFFSET_CH1 = -3.0* 200 * 1e-3 # 100mV per div
