...
class PlotWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.energy_layout.addWidget(QLabel(f"Energy consumption: {np.trapz(self.power, self.processor.time):.2f} mJ"))
    ...
    def update_plot(self):
        try:
            ...
            energy = np.trapz(self.power[start_idx:end_idx], trimmed_time)
    ...
    def save_plot(self):
        ...
        print(f"Energy consumption: {np.trapz(self.power[self.file_info['trim_start']:self.file_info['trim_end']], self.centered_time[self.file_info['trim_start']:self.file_info['trim_end']]):.2f} mJ")
...
def main():
    ...
    csv_files = {
        0: {'filename': 'data_44_000.csv', 'trim_start' : 0, 'trim_end': -1},
        1: {'filename': 'data_44_001.csv', 'trim_start' : 0, 'trim_end': -1},
        2: {'filename': 'data_44_002.csv', 'trim_start' : 0, 'trim_end': -1},
        3: {'filename': 'data_44_003.csv', 'trim_start' : 0, 'trim_end': -1},
        4: {'filename': 'data_44_004.csv', 'trim_start' : 0, 'trim_end': -1},
        5: {'filename': 'data_44_005.csv', 'trim_start' : 0, 'trim_end': -1},
        6: {'filename': 'data_44_006.csv', 'trim_start' : 0, 'trim_end': -1},
        7: {'filename': 'data_44_010.csv', 'trim_start' : 0, 'trim_end': -1},
        8: {'filename': 'data_44_011.csv', 'trim_start' : 0, 'trim_end': -1},
        9: {'filename': 'data_44_012.csv', 'trim_start' : 0, 'trim_end': -1},
        10: {'filename': 'data_44_013.csv', 'trim_start' : 0, 'trim_end': -1},
    }

    R = 100.54
    OFFSET_CH1 = 2.5 * 100 * 1e-3 # 100mV per div
